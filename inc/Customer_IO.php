...
function signup_form($args = [])
{
	...
	$form_class = 'form-email';
	if ($args['is_post']) $form_class = 'form-wrap';
	if ($args['is_webinar']) $form_class = 'form';
	?>
	<a name="signup-form-<?= ($args["position"] ?? "") ?>"></a>
	<div class="mc4wp-form __this-is-not-mc4wp-class-just-preserved-for-styling">
		<form method="POST" action="https://eu.customerioforms.com/forms/submit_action?site_id=de10c64e88e15af323dd&form_id=2bc27846b8da440&success_url=<?= urlencode($return_url) ?>" class="<?= $form_class ?>">
			...
			<div class="mc4wp-form-fields<?php if($args['is_post']) echo ' input-wrap' ?>">
				...
				<input type="email" id="email_input" name="email" placeholder="<?= $args['placeholder'] ?? 'Email' ?>" required>
